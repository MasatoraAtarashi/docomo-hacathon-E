...
fishing_community = Community.create(name: '釣りコミュニティ', url: 'https://discord.gg/uYebc84')
study_community = Community.create(name: '勉強会コミュニティ', url: 'https://discord.gg/uYebc84')
